...
const sectionSchema = z.object({
  title: z
    .string()
    .trim()
    .min(1, "عنوان بخش الزامی است")
    .max(255, "عنوان بخش باید حداکثر ۲۵۵ کاراکتر باشد"),
  description: z.string().trim().min(1, "توضیحات بخش الزامی است"),
  imageUrl: z
    .string()
    .trim()
    .max(500, "آدرس تصویر بخش باید حداکثر ۵۰۰ کاراکتر باشد")
    .optional(),
});
...
const blogSchema = z.object({
  ...
  slug: z
    .string()
    .trim()
    .max(220, "اسلاگ باید حداکثر ۲۲۰ کاراکتر باشد")
    .optional(),
  ...
  metaTitle: z
    .string()
    .max(255, "عنوان سئو باید حداکثر ۲۵۵ کاراکتر باشد")
    .optional(),
  metaDescription: z
    .string()
    .max(4000, "توضیحات سئو باید حداکثر ۴۰۰۰ کاراکتر باشد")
    .optional(),
  keywords: z
    .string()
    .max(4000, "کلمات کلیدی باید حداکثر ۴۰۰۰ کاراکتر باشد")
    .optional(),
  canonical: z
    .string()
    .max(500, "Canonical باید حداکثر ۵۰۰ کاراکتر باشد")
    .optional(),
  ogImage: z
    .string()
    .max(2048, "آدرس تصویر OG باید حداکثر ۲۰۴۸ کاراکتر باشد")
    .optional(),
...
<template>
  <UModal
    ...
    :title="isEditing ? 'ویرایش بلاگ' : 'ایجاد بلاگ'"
  >
    <template #body>
      <UForm
        :schema="blogSchema"
      ...
      >
        ...
        <section class="space-y-4 rounded-xl border border-default p-4">
          ...
          <UFormField label="انتخاب محصولات" name="productIds">
            <USelectMenu
