    ...
    <div class="flex min-h-0 flex-1 overflow-hidden">
      ...
      <section class="flex min-h-0 min-w-0 flex-1 flex-col">
        <div
          ...
          class="flex shrink-0 items-center gap-3 border-b border-default bg-default px-4 py-2.5 lg:px-6"
        >
          <UButton
            color="neutral"
            variant="soft"
        ...
        <div
          class="shrink-0 border-t border-default bg-default px-4 py-3 lg:px-6"
        >
          <div
            class="flex flex-wrap items-center justify-between gap-3"
          >
            <p class="text-sm text-muted">
              نمایش {{ rangeStart }} تا {{ rangeEnd }} از {{ totalProducts }}
              محصول
            </p>
