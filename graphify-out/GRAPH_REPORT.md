...
## Corpus Check
- 509 files · ~2,601,949 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4608 nodes · 7524 edges · 347 communities (239 shown, 108 thin omitted)
...
Cohesion: 0.09
Nodes (24): CreateCommentDto, IsEnum, IsString, IsUUID, MaxLength, MinLength, LikeStatusQueryDto, IsEnum (+16 more)
...
Cohesion: 0.14
Nodes (14): ChatAdminRawRow, ChatUserRawRow, CreateChatDto, IsOptional, IsString, MaxLength, ChatReadFilter, ChatStatusFilter (+6 more)
...
### Community 20 - "CartController"
Cohesion: 0.19
Nodes (11): CartController, Body, Controller, Delete, Get, HttpCode, Param, Patch (+3 more)

### Community 21 - "BehaviorController"
Cohesion: 0.22
Nodes (10): BehaviorController, Body, Controller, Get, HttpCode, Param, Post, Query (+2 more)

### Community 22 - "Comment"
Cohesion: 0.11
Nodes (18): Comment, Column, CreateDateColumn, DeleteDateColumn, Entity, Index, JoinColumn, ManyToOne (+10 more)
...
Cohesion: 0.16
Nodes (8): AdminController, Controller, Get, Req, UseGuards, AdminService, Injectable, InjectRepository
...
Cohesion: 0.09
Nodes (23): cache-manager, class-transformer, @nestjs/cache-manager, @nestjs/common, @nestjs/config, @nestjs/mapped-types, passport-jwt, passport-local (+15 more)
...
Cohesion: 0.08
Nodes (23): dataSource, CreateOrderDto, IsUUID, QueryOrdersDto, IsEnum, IsInt, IsOptional, Max (+15 more)
...
Cohesion: 0.06
Nodes (41): CreateNotificationDto, IsEnum, IsNotEmpty, IsString, IsUUID, MaxLength, QueryNotificationsDto, IsBoolean (+33 more)
...
### Community 97 - "product.service.ts"
Cohesion: 0.07
Nodes (34): ChangeProductStatusDto, IsEnum, CreateProductDto, ArrayMaxSize, IsArray, IsBoolean, IsEnum, IsNumber (+26 more)
...
Cohesion: 0.06
Nodes (41): CartModule, Module, Product, ProductSpecification, Column, CreateDateColumn, DeleteDateColumn, Entity (+33 more)
...
Cohesion: 0.07
Nodes (29): AddressesModule, Module, AdminModule, Module, AppController, Controller, Get, AppModule (+21 more)
...
Cohesion: 0.11
Nodes (20): AuthenticatedRequest, AddressesService, Injectable, InjectRepository, CreateAddressDto, IsString, Length, Matches (+12 more)
...
Cohesion: 0.09
Nodes (26): Column, CreateDateColumn, Entity, PrimaryGeneratedColumn, UserEntity, Favorite, Column, CreateDateColumn (+18 more)
...
Cohesion: 0.08
Nodes (22): AuthenticatedRequest, CartService, Injectable, AddCartItemDto, CartSelectedOptionDto, ArrayMaxSize, IsArray, IsInt (+14 more)
...
### Community 196 - "orders.service.ts"
Cohesion: 0.08
Nodes (36): InjectRepository, CartItem, Column, CreateDateColumn, Entity, Index, JoinColumn, ManyToOne (+28 more)
...
### Community 200 - "AddressesController"
Cohesion: 0.17
Nodes (11): AddressesController, Body, Controller, Delete, Get, HttpCode, Param, Patch (+3 more)
...
### Community 277 - "QueryChatsDto"
Cohesion: 0.25
Nodes (7): QueryChatsDto, IsEnum, IsInt, IsOptional, Max, Min, Type
...
Cohesion: 0.17
Nodes (11): resolveBlogCanonical(), resolveBlogOgImage(), resolveBlogSocialTitle(), resolveBlogTitle(), resolveProductCanonical(), resolveProductImages(), resolveProductOgImage(), resolveProductTitle() (+3 more)

### Community 299 - "requireLogin"
Cohesion: 0.50
Nodes (4): requireLogin(), submitComment(), toggleFavorite(), toggleLike()

### Community 303 - "QueryMessagesDto"
Cohesion: 0.29
...
### Community 333 - "QueryContactMessagesDto"
Cohesion: 0.06
...
## Knowledge Gaps
- **1113 isolated node(s):** `colorMode`, `route`, `requestURL`, `isNoindexPage`, `color` (+1108 more)
...
- **Why does `StoreManager` connect `StoreManager` to `TBanner`, `TStory`, `TBrand`, `FavoritesDS`, `orders/types/index.type.ts`, `FilesDS`, `AddressesDS`, `UsersDS`, `CategoriesDS`, `PricingProductRow.vue`, `CartDS`, `NotificationsDS`, `ProductsDS`, `InteractionsDS`, `TDashboardData`?**
  _High betweenness centrality (0.305) - this node is a cross-community bridge._
- **Why does `CartItemModel` connect `CartDS` to `CartService`?**
  _High betweenness centrality (0.205) - this node is a cross-community bridge._
- **Why does `CartItem` connect `orders.service.ts` to `CartService`, `Comment`, `Product`, `UserEntity`?**
