...
## Corpus Check
- 376 files · ~2,556,261 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3272 nodes · 5197 edges · 265 communities (176 shown, 89 thin omitted)
...
## Communities (265 total, 89 thin omitted)
...
Cohesion: 0.05
Nodes (41): activeVariant, addingToCart, addToCart(), comments, commentsLoaded, commentsLoading, commentsMeta, commentSubmitting (+33 more)
...
### Community 23 - "JwtAuthGuard"
Cohesion: 0.07
Nodes (26): JwtAuthGuard, Injectable, FavoriteToggleDto, IsUUID, Favorite, Column, CreateDateColumn, Entity (+18 more)
...
### Community 31 - "ProductController"
Cohesion: 0.12
...
### Community 36 - "CartService"
Cohesion: 0.06
Nodes (35): AuthenticatedRequest, CartController, Body, Controller, Delete, Get, HttpCode, Param (+27 more)

### Community 37 - "attributes/data/index.store.ts"
Cohesion: 0.48
...
### Community 80 - "notifications.controller.ts"
Cohesion: 0.06
...
Cohesion: 0.13
Nodes (10): AuthService, Injectable, LoginDto, IsString, MinLength, JwtStrategy, Inject, Injectable (+2 more)
...
### Community 129 - "Roles"
Cohesion: 0.18
Nodes (8): AuthenticatedRequest, CreateChatDto, IsOptional, IsString, MaxLength, Roles(), RolesGuard, Injectable
...
### Community 196 - "File"
Cohesion: 0.21
Nodes (7): File, Column, Entity, PrimaryGeneratedColumn, FileModule, Module, InjectRepository
...
## Knowledge Gaps
- **777 isolated node(s):** `colorMode`, `route`, `isNoindexPage`, `color`, `Props` (+772 more)
...
- **Why does `StoreManager` connect `StoreManager` to `TBanner`, `TStory`, `FavoritesDS`, `FilesDS`, `UserProfileDS`, `CartDS`, `TAdmin`, `NotificationsDS`, `user/data/index.store.ts`, `InteractionsDS`?**
...
- **Why does `CartItem` connect `CartService` to `UserEntity`, `ProductVariant`, `Product`?**
